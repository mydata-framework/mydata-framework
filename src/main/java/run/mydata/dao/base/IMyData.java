...
public interface IMyData<POJO> {
     ...
     * 查询总记录数
     * @param pms 条件 .
     * @param distincts   distincts is COUNT(distincts), NULL is COUNT(*) .
     * @return .
     */
     ...
     * 根据条件查询所有记录
     * @param pms 条件 .
     * @param cls SELECT cls FROM pms ;  NULL is  SELECT * FROM pms .
     * @return .
     */
     ...
     * @param pms .
     * @param cls  NULL is SELECT * FROM TABLE WHERE pms ORDER BY orderbys .
     * @return .
     */
     ...
     * @param cls NULL is SELECT * FROM TABLE ORDER BY orderbys .
     * @return .
     */
     ...
     * @param cls NULL is SELECT * FROM TABLE WHERE ID IN (ids) .
     * @return .
     */
     ...
     * @param vls .
     * @param cls NULL is SELECT * FROM TABLE WHERE propertyName IN (vls) .
     * @return .
     */
     ...
     * @param cls NULL is SELECT * FROM TABLE WHERE ID=id .
     * @return .
     */
     ...
     * @param pageSize .
     * @param pms .
     * @param cls NULL is SELECT * FROM TABLE WHERE pms LIMIT 1,10 .
     * @return .
     */
     ...
     * @param pms .
     * @param orderbys .
     * @param cls NULL is SELECT * FROM TABLE WHERE pms ORDER BY orderbys LIMIT ... curPage 1,pageSize 10 .
     * @return .
     */
     ...
     * @param curPage .
     * @param pageSize .
     * @param cls NULL is  SELECT * FROM TABLE WHERE pms LIMT 1,10 .
     * @return .
     */
